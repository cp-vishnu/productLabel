...
namespace Codilar\ProductLabel\Block\Adminhtml\Catalog\ConditionField;
...
class Condition extends Generic implements TabInterface
{
    ...
    public function __construct(
        ...
        \Codilar\ProductLabel\Model\LabelFactory $CustomConditionFactory,
        array $data = []
    ) {
    ...
    private function getRuleFactory()
    {
        if ($this->ruleFactory === null) {
            $this->ruleFactory = ObjectManager::getInstance()->get('Codilar\Label\Model\CustomConditionFactory');
        }
    ...
    protected function addTabToForm(
        ...
        $formName = 'productlabel_product_adding'
    ) {
        if (!$model) {

...
namespace Codilar\Label\Block\Adminhtml\Catalog\ConditionField;
...
class Condition extends Generic implements TabInterface
{
    ...
    public function __construct(
        ...
        \Codilar\Label\Model\LabelConditionFactory $LabelConditionFactory,
        array $data = []
    ) {
        $this->_rendererFieldset = $rendererFieldset;
        $this->_conditions = $conditions;
        $this->LabelConditionFactory = $LabelConditionFactory;
    ...
    private function getRuleFactory()
    {
        if ($this->ruleFactory === null) {
            $this->ruleFactory = ObjectManager::getInstance()->get('Codilar\Label\Model\LabelConditionFactory');
        }
